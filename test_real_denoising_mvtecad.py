...
parser.add_argument('--input_dir', default='./Datasets/test/MVTECAD/', type=str, help='Directory of validation images')
parser.add_argument('--result_dir', default='./results/Real_Denoising/MVTECAD/', type=str, help='Directory for results')
